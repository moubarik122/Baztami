        ...
        budgetRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
             ...
             for (DataSnapshot snap: snapshot.getChildren()){
                 ...
                 String sTotal = String.valueOf("Month budget:"+ totalAmount+"Dh");
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.getChildrenCount()>0){
                    ...
                    for (DataSnapshot snap:snapshot.getChildren()){
                        ...
                        String sttotal=String.valueOf("Month Budget: "+totalammount+" Dh");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Data, MyViewHolder> adapter = new FirebaseRecyclerAdapter<Data, MyViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull MyViewHolder holder, final int position, @NonNull final Data model) {
                ...
                holder.setItemAmount("Allocated amount: "+ model.getAmount()+" Dh");
